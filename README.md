...
| -------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **[Enterprise-AI-Content-Moderation-Risk-Platform](https://github.com/emmanueljirehb/Enterprise-AI-Content-Moderation-Risk-Platform)** | Built an enterprise-grade AI moderation & risk scoring system using multi-model architecture (Vision + NLP) for detecting NSFW, copyrighted content & risk signals. | ![Python](https://img.shields.io/badge/Python-blue) • ![FastAPI](https://img.shields.io/badge/FastAPI-green) • ![Deep Learning](https://img.shields.io/badge/Deep%20Learning-red) • ![MySQL](https://img.shields.io/badge/MySQL-orange) |
| **[Multimodal-Invoice-Extraction-System](https://github.com/emmanueljirehb/Multimodal-Invoice-Extraction-System)**                     | Developed an intelligent invoice extraction system using OCR + NLP to convert unstructured invoices into structured financial data.                                 | ![Python](https://img.shields.io/badge/Python-blue) • ![OCR](https://img.shields.io/badge/OCR-yellow) • ![NLP](https://img.shields.io/badge/NLP-purple) • ![FastAPI](https://img.shields.io/badge/FastAPI-green)                        |
...
| **[web_fact_checker](https://github.com/emmanueljirehb/web_fact_checker)**                                                             | Developed a Python-based fact-checking tool for validating web content claims.                                                                                      | ![Python](https://img.shields.io/badge/Python-blue) • ![Fact-Checking](https://img.shields.io/badge/Fact-Checking-green)                                                                                                                |
...
| **[RAG-using-SQL-Queries-telugu_movies_dataset](https://github.com/emmanueljirehb/RAG-using-SQL-Queries-telugu_movies_dataset)**       | Applied RAG techniques with SQL queries on a Telugu movies dataset.                                                                                                 | ![RAG](https://img.shields.io/badge/RAG-purple) • ![SQL](https://img.shields.io/badge/SQL-blue)                                                                                                                                         |
